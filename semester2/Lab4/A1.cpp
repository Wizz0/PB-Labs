...
//создай файл prob№_in.txt с ввденными данными в папке проекта.
//Да, в онлайн IDE это не получится, на наших компах вроде только
//DevC++ и CodeBlocks более менее рабочие.
