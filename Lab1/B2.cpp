//B2
//Дано действительные числа x, y. Не пользуясь никакими другими арифметическими операциями, кроме умножения,
//сложения и вычитания, вычислить 5x2y2 − 3xy2 − 17x2y − 2y2 + 5xy + 2x^2 − 4x + 11y + 7
