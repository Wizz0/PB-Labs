...
//Дана строка, состоящая из латинских букв, пробелов и знаков пунктуации. Проверьте,
//является ли строка палиндромом (т.е. читается одинаково слева направо и справа налево)
//без учета пробелов и знаков пунктуации, а также без учета регистра букв: YES, если она
//является палиндромом, и NO в противном случае.
//Пример.
//Ввод: Madam, I’m Adam Вывод: YES
